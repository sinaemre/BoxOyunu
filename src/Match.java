public class Match {
    ...
    Match(Fighter f1, Fighter f2) {
        ...
        this.isTrueWeigs = this.extractWeight <= this.rangeWeight;
    ...
    public void run() {
        if (!this.isTrueWeigs) { // dövüşçüler arasında ki kilo farkı en fazla rangeWeight değeri kadar olsun
    ...
    private void subRun(Fighter sonrakiVuracak, Fighter ilkVuracak) { // üsteki run fonkiyonunda ilk vurana göre burada alt fonksiyonda sırası ile vuruşları gerçkeleştiriyoruz
